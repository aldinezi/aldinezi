  ...
  const jobs: Job[] = [
    {
      ...
      responsibilities: [
        ...
        'Architected Agents V2 — built agent interaction layer via comment system with user source attribution, enabling structured human-agent collaboration workflows',
        'Led migration of frontend build tooling from Vue CLI/webpack to Vite, integrating modern linting, pre-commit hooks, and CI improvements to boost developer velocity',
        ...
        'Owned Cypress e2e suite covering full signup and core workflow regressions, replacing third-party test infrastructure and triggering on every production deploy',
